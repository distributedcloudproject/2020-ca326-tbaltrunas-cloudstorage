...
func (wapp *webapp) WebAuthLoginHandler(w http.ResponseWriter, req *http.Request) {
...
// Should send cookies.
func (wapp *webapp) WebAuthRefreshHandler(w http.ResponseWriter, req *http.Request) {
